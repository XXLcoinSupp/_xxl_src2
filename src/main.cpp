...
// Copyright (c) 2013-2014 XXLcoin Developers
...
uint256 hashGenesisBlock("0x82e23c3be9251dcb6737b28c898f13f987165c1eba55f0461e3347b9c3b0db76");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // XXLcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "XXLcoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees, uint256 prevHash)
{
        ...
        int rand = generateMTRandom(seed, 9999990);
        int rand1 = 0;
        int rand2 = 0;
        int rand3 = 0;
        int rand4 = 0;
		...
		else if(nHeight < 100000)      
        {
                ...
                seed = hex2long(cseed);
                randx = generateMTRandom(seed, 4999990);
                nSubsidy = (1 + randx) * COIN;
        }
        else if(nHeight < 200000)      
        {
                ...
                cseed = cseed_str.c_str();
                seed = hex2long(cseed);
                rand1 = generateMTRandom(seed, 2499990);
        ...
        else if(nHeight < 300000)      
        {
                ...
                cseed = cseed_str.c_str();
                seed = hex2long(cseed);
                rand2 = generateMTRandom(seed, 1209990);
        ...
        else if(nHeight < 400000)      
        {
                ...
                cseed = cseed_str.c_str();
                seed = hex2long(cseed);
                rand3 = generateMTRandom(seed, 499990);
        ...
        else if(nHeight < 500000)      
        {
                ...
                cseed = cseed_str.c_str();
                seed = hex2long(cseed);
                rand4 = generateMTRandom(seed, 249900);
        ...
        else if(nHeight < 600000)      
        {
                ...
                cseed = cseed_str.c_str();
                seed = hex2long(cseed);
                rand5 = generateMTRandom(seed, 120090);
...
static const int64 nTargetTimespan = 2 * 60 * 60; // XXLcoin: every 2 hours
static const int64 nTargetSpacing = 120; // XXLcoin: 2 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // XXLcoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal XXLcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "XXLcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "XXLcoinStart";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x24558fcb8a9e86af0847671f1e0b479f8d232e080b3517382a3e0a8ea1e61a51"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // XXLcoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
