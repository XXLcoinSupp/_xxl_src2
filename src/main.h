...
static const int64 MAX_MONEY = 2800000000000 * COIN; // XXLcoin: maximum of 2.8k B coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 100 * COIN * 720 / 250; // XXLcoin: 1440 blocks found a day. Priority cutoff is 100 XXLcoin day / 250 bytes.
    }
